import pandas as pd
import numpy as np
from task2_preprocess_hj import *
...
#model.fit(x_clean, y_clean, batch_size=300, epochs=200, verbose=1)
#
#y_kpred = np.argmax(model.predict(x_test_norm), axis=1)
#
#score = balanced_accuracy_score(y_ktest,  y_kpred_vote)
#
...
model.fit(x_clean, y_clean, batch_size=300, epochs=200, callbacks=[EarlyStopping(monitor='loss', patience=4)], verbose=1)
